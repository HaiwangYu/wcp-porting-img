...
// Import tools from dunereco/DUNEWireCell/common/ which defines elec_resps
// (plural, needed by sp.jsonnet). Requires DUNEWireCell on WIRECELL_PATH
// before toolkit/cfg — cmd_run_sim_check.py sets this up.
