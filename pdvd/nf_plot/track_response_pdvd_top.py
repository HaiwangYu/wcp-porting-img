...
def make_plot(wave_adc, chndb_ref, tick_us, plane_label, pitch_mm, n_mip_pl, outpath, er_info):
    N = len(wave_adc)
...
def run():
    ...
    for pl in fr.planes:
        ...
        make_plot(wave_adc, chndb_ref, tick_us, label, pl.pitch, n_mip_pl, outpath, er_info)
